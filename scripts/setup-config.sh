...
envsubst '${ORTHANC_AET} ${ORTHANC_DB_USER} ${ORTHANC_DB_PASS} ${ORTHANC_ADMIN_USER} ${ORTHANC_ADMIN_PASS} ${MODALITY_MERCURE_JSON} ${MODALITY_LPCHROUTER_JSON} ${MODALITY_LPCHTROUTER_JSON} ${MODALITY_MODLINK_JSON} ${MODALITY_MODLINKTEST_JSON}' \
