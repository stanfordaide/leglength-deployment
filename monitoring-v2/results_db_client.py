...
Stores results.json in PostgreSQL JSONB format, queryable by study_id.
"""
...
class ResultsDBClient:
    ...
    Usage:
        ...
        client.store_result(study_id="abc123", results_json={...})
        results = client.get_by_study_id("abc123")
    """
